...
public final class AssetTransfer implements ContractInterface {
    ...
    /**
     * Create duplicate asset of existing asset and assign to a new owner
     *
     * @param ctx the transaction context
     * @param assetID the ID of the asset to be duplicated
     * @param owner owner of duplicate asset
     * @return the duplcate asset
     */
    @Transaction(intent = Transaction.TYPE.SUBMIT)
    public Asset DuplicateAsset(final Context ctx, final String assetID, final String owner) {
        ...
        String duplicateAssetId = "duplicate-" + assetID;
        Asset duplicateAsset = CreateAsset(ctx, duplicateAssetId, asset.getColor(), asset.getSize(), owner, asset.getAppraisedValue());
